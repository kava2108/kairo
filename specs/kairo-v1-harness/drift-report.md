...
---
kairo:
  node_id: "drift-report:kairo-v3-harness"
  artifact_type: "drift-report"
  phase: "OPS"
...
| CEG frontmatter | kairo: / coherence: 両ブロック必須 | ✅ post-tool-use.sh によるインジェクト | 一致 | COVERED | 0 |
...
次推奨アクション: /kairo:sync kairo-v3-harness
```
