...
# 実行: bash specs/kairo-v1-harness/tests/T07/test_coherence_scan.sh
#
...
test_tc01_coherence_json_contains_known_nodes() {
  ...
  local known_nodes=(
    "imp:kairo-v3-harness"
    "test:kairo-v3-harness:T01"
    "test:kairo-v3-harness:T03"
    "test:kairo-v3-harness:T07"
    "adversary:kairo-v3-harness"
  )
