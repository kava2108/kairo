---
kairo:
  node_id: "test:kairo-v3-harness:T07"
...
# テストケースマトリクス: kairo-v3-harness / T07
...
| **入力** | `/kairo:coherence-scan kairo-v3-harness` を実行 |
...
| **優先度** | P1 |
| **レイヤー** | unit |
| **前提条件** | `specs/kairo-v1-harness/tests/broken.md` に不正な YAML frontmatter が含まれる |
| **入力** | `coherence-scan` を実行 |
