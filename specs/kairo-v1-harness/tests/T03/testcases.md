---
kairo:
  node_id: "test:kairo-v3-harness:T03"
...
# テストケースマトリクス: kairo-v3-harness / T03
...
| **入力** | `check_phase_gate "IMP" "TEST" "kairo-v3-harness"` |
...
| **優先度** | P0 |
| **レイヤー** | unit |
| **前提条件** | `IMP->TEST` で必要な `specs/kairo-v1-harness/IMP.md` が存在しない |
| **入力** | `check_phase_gate "IMP" "TEST" "kairo-v3-harness"` |
...
| **入力** | `check_phase_gate "OPS" "CHANGE" "kairo-v3-harness"` |
