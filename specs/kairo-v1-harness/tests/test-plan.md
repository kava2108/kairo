---
kairo:
  node_id: "test-plan:kairo-v3-harness"
...
coherence:
  ...
  depends_on:
    ...
    - id: "test:kairo-v3-harness:T01"
      ...
      confidence: 1.0
      required: false
    - id: "test:kairo-v3-harness:T02"
      relation: "aggregates"
      confidence: 1.0
      required: false
    - id: "test:kairo-v3-harness:T03"
      relation: "aggregates"
      confidence: 1.0
      required: false
    - id: "test:kairo-v3-harness:T04"
      ...
      confidence: 1.0
      required: false
    - id: "test:kairo-v3-harness:T05"
      relation: "aggregates"
      confidence: 1.0
      required: false
    - id: "test:kairo-v3-harness:T06"
      relation: "aggregates"
      confidence: 1.0
      required: false
...
# テスト計画書: kairo-v3-harness（V-Model All）

**Feature**: kairo v3.0 Harness Engineering 統合  
**IMP バージョン**: 1.1.0  
**生成日**: 2026-04-05  
...
kairo v3.0 Harness Engineering の実装は以下の 3 層で検証する。
...
| **e2e 環境** | GitHub テスト用リポジトリ（`kava2108/kairo-e2e-sandbox`） |
...
- **ShellCheck** が `.kairo/lib/*.sh`, `.kairo/hooks/*.sh` でエラー 0 件であること
