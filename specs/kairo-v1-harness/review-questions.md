...
**対象箇所**: `.kairo/hooks/post-tool-use.sh` L33—L42
...
**対象箇所**: `.kairo/hooks/post-tool-use.sh` L18-25
...
**対象箇所**: `specs/kairo-v1-harness/tests/` ディレクトリ
...
**対象箇所**: `.kairo/hooks/post-tool-use.sh` L44-55
...
**対象箇所**: `.kairo/lib/phase-gate.sh` `_gh_with_retry()` 関数
