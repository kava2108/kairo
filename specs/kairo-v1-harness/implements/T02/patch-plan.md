---
kairo:
  node_id: "impl:kairo-v3-harness:T02"
...
**Issue**: [#2](https://github.com/kava2108/kairo/issues/2)  
**IMP バージョン**: 1.1.0  
**実装日**: 2026-04-05
...
| `.kairo/templates/imp-template.md` | 新規作成（frontmatter 付き IMP ひな形） | ✅ 実装済み |
