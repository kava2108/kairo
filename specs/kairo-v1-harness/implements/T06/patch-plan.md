---
kairo:
  node_id: "impl:kairo-v3-harness:T06"
...
**Issue**: [#6](https://github.com/kava2108/kairo/issues/6)  
**IMP バージョン**: 1.1.0  
**実装日**: 2026-04-05
...
| ファイル | 操作 | 状態 |
|---------|------|------|
| `.kairo/agents/test-agent.md` | 新規作成 | ✅ 実装済み |
| `.kairo/agents/adversary-agent.md` | 新規作成 | ✅ 実装済み |
| `.kairo/agents/ops-agent.md` | 新規作成 | ✅ 実装済み |
| `.kairo/agents/change-agent.md` | 新規作成 | ✅ 実装済み |
