---
kairo:
  node_id: "impl:kairo-v3-harness:T01"
...
**Issue**: [#1](https://github.com/kava2108/kairo/issues/1)  
**IMP バージョン**: 1.1.0  
**実装日**: 2026-04-05
...
| `.kairo/hooks/post-tool-use.sh` | 新規作成 | ✅ 実装済み |
...
- step8: `--harness` あり時に以下を実行:
  ...
  - `.kairo/hooks/post-tool-use.sh` 生成 + chmod +x
