...
- テンプレートを Read する（以下の順で探索し、最初に見つかったものを使用する）：
  - `~/.claude/commands/kairo/templates/rev-spec-template.md`
  - `.claude/commands/kairo/templates/rev-spec-template.md`
...
- テンプレートを Read する（以下の順で探索し、最初に見つかったものを使用する）：
  - `~/.claude/commands/kairo/templates/rev-api-template.md`
  - `.claude/commands/kairo/templates/rev-api-template.md`
...
- テンプレートを Read する（以下の順で探索し、最初に見つかったものを使用する）：
  - `~/.claude/commands/kairo/templates/rev-schema-template.md`
  - `.claude/commands/kairo/templates/rev-schema-template.md`
...
- テンプレートを Read する（以下の順で探索し、最初に見つかったものを使用する）：
  - `~/.claude/commands/kairo/templates/rev-requirements-template.md`
  - `.claude/commands/kairo/templates/rev-requirements-template.md`
...
IMP との差分が検出された場合：
- 差分件数を表示する
- `/kairo:drift_check {{issue_id}}` の実行を推奨する
...
- 以下を表示する：
  ...
  IMP との差分: N 件
  次のステップ:
    乖離詳細確認:  /kairo:drift_check {{issue_id}}
    全体同期:      /kairo:sync {{issue_id}}
  ```
