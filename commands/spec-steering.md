...
出力ファイル=.kairo/steering/structure.md, .kairo/steering/tech.md, .kairo/steering/product.md
...
### .kairo/steering/structure.md の生成
...
対応するファイルを `.kairo/steering/custom/<domain>.md` に生成する：
...
> `.kairo/steering/` を自動的に読み込み、技術スタック・規約に沿った出力を生成します。
