...
| U10 | アンチパターン | MASTER.md のアンチパターンセクションに記載された UI パターンに違反していないか |
...
評価手順:
1. `design-system/MASTER.md` を Read する（`/kairo:design-system` が生成したデザインシステム）。
...
4. 以下のいずれかに該当すれば FAIL:
   ...
   - MASTER.md のアンチパターンセクションに記載された UI パターンが実装に存在する
