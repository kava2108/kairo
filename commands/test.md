...
- $ARGUMENTS がない場合は「引数に issue-id を指定してください（例: /kairo:test 001-feature-name）」と言って終了する
- $ARGUMENTS を解析する：
...
- テンプレートを Read する（以下の順で探索し、最初に見つかったものを使用する）：
  - `~/.claude/commands/kairo/templates/testcases-template.md`
  - `.claude/commands/kairo/templates/testcases-template.md`
...
- テンプレートを Read する（以下の順で探索し、最初に見つかったものを使用する）：
  - `~/.claude/commands/kairo/templates/test-plan-template.md`
  - `.claude/commands/kairo/templates/test-plan-template.md`
...
- テンプレートを Read する（以下の順で探索し、最初に見つかったものを使用する）：
  - `~/.claude/commands/kairo/templates/test-results-template.md`
  - `.claude/commands/kairo/templates/test-results-template.md`
